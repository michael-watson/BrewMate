...
namespace BrewMate_TestProject
{
	...
	{
		public static void ScrollDownMore(this IApp app, string screenshot = null)
		{
			var windowRect = app.Query (x => x.Class ("UIWindow")) [0].Rect;
			var scrolllength = 200;

			app.DragCoordinates (
				windowRect.CenterX,
				windowRect.CenterY + scrolllength,
				windowRect.CenterX,
				windowRect.CenterY - scrolllength
			);
		...
		public static void ScrollUpAndTap(this IApp app, Func<AppQuery, AppQuery> lambda, string screenshot = null)
		{
		...
		public static void ScrollDownAndTap(this IApp app, Func<AppQuery, AppQuery> lambda = null, string screenshot = null)
		{
			...
			app.Screenshot ("Scroll down to see row");
			app.Tap(lambda);
		...
		public static void TapCoordinates(this IApp app, float x, float y, string screenshot)
		{
