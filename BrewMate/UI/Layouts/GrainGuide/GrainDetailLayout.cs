...
namespace BrewMate
{
	public class GrainDetailLayout : StackLayout
	{
		public GrainDetailLayout (Grains selectedGrain)
		{
			...
			Spacing = 20;
			Children.Add (new Frame { Content = nameStack, BackgroundColor = Color.Transparent });
			Children.Add (layout);
