		...
		public static List<Hops> GetHops()
		{
			List<Hops> hops = new List<Hops> {
				...
				new Hops {
					...
					AAHigh = 8,
					Type = "All Purpose",
					Substitutes = "Bullion, Northern Brewer, Galena ",
				...
				new Hops {
					...
					AAHigh = 9,
					Type = "All Purpose",
					Substitutes = "Bullion, Northern Brewer, Galena ,Bramling Cross",
				...
				new Hops {
					...
					AAHigh = 11,
					Type = "All Purpose",
					Substitutes = "Simcoe , other fruity citrusy \"C\" hops ",
				...
				new Hops {
					...
					AAHigh = 16,
					Type = "All Purpose",
					Substitutes = "Centennial, Chinook, Galena, Nugget, Zeus/Tomahawk",
				...
				new Hops {
					...
					AAHigh = 16,
					Type = "All Purpose",
					Substitutes = "Chinook, Galena, Cluster",
				...
				new Hops {
					...
					AAHigh = 8,
					Type = "Finishing",
					Substitutes = "Hallertau Mittelfrüh, Tettnanger, Spalter, Saaz",
				...
				new Hops {
					...
					AAHigh = 14,
					Type = "Bittering",
					Substitutes = "Amarillo, Cascade, Centennial",
